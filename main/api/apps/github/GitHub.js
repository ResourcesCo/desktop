...
function getHeaders(apiToken, post) {
    ...
    return __assign({ Authorization: "token " + apiToken }, (post ? { 'Content-Type': 'application/json' } : {}));
}
function auth(_a) {
...
function issueApiUrl(_a) {
    var owner = _a.owner, repo = _a.repo, number = _a.number;
    return "https://api.github.com/repos/" + owner + "/" + repo + "/issues/" + number;
}
function close(_a) {
    var apiToken = _a.env.GITHUB_TOKEN, params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        var res;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, isomorphic_unfetch_1["default"](issueApiUrl(params), {
                        method: 'PATCH',
                ...
                case 1:
                    res = _b.sent();
                    if (res.ok) {
                        return [2 /*return*/, { type: 'text', text: "Issue closed" }];
                    }
                    else {
                        return [2 /*return*/, { type: 'text', text: "Error closing issue" }];
                    }
                    return [2 /*return*/];
            }
        });
...
function comment(_a) {
    var apiToken = _a.env.GITHUB_TOKEN, _b = _a.params, comment = _b.comment, params = __rest(_b, ["comment"]);
    return __awaiter(this, void 0, void 0, function () {
        var res;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, isomorphic_unfetch_1["default"](issueApiUrl(params) + "/comments", {
                        method: 'POST',
                        headers: getHeaders(apiToken, true),
...
function run(_a) {
    var action = _a.action, env = _a.env, params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    if (!env.GITHUB_TOKEN) return [3 /*break*/, 7];
                    if (!(action === 'close')) return [3 /*break*/, 4];
                    return [4 /*yield*/, close({ env: env, params: params })];
                case 3: return [2 /*return*/, _b.sent()];
                case 4:
                    if (!(action === 'comment')) return [3 /*break*/, 6];
                    return [4 /*yield*/, comment({ env: env, params: params })];
